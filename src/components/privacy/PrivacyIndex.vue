    ...
    <div class="py-16 bg-white dark:bg-gray-800 overflow-hidden">
      <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          "
        >
          <p>Effective date: 2021-05-01</p>
          <p>1. <strong>Introduction</strong></p>
          <p>Welcome to <strong> Switcheo Squad</strong>.</p>
          <p>
            <strong>Switcheo Squad</strong> (“us”, “we”, or “our”) operates
            <strong>switcheosquad.com</strong> (hereinafter referred to as
            <strong>“Service”</strong>).
          </p>
          <p>
            Our Privacy Policy governs your visit to
            <strong>switcheosquad.com</strong>, and explains how we collect,
          ...
          <p>
            <strong>SERVICE</strong> means the switcheosquad.com website
            operated by Switcheo Squad.
          </p>
          <p>
          ...
          <p>
            0.2. <strong>Preference Cookies:</strong> We use Preference Cookies
          ...
          <p>Switcheo Squad uses the collected data for various purposes:</p>
          ...
          <p>
            Switcheo Squad will take all the steps reasonably necessary to
          ...
          <p>
            ...
            <strong>privacy@switcheosquad.com</strong>.
          </p>
          <p>
          ...
          <p>
            ...
            us at <strong>privacy@switcheosquad.com</strong>.
          </p>
          ...
          <p>
            18. <strong><strong>Children’s Privacy</strong></strong>
          </p>
          <p>
          ...
          <p>
            ...
            us by email: <strong>privacy@switcheosquad.com</strong>.
          </p>
        </div>
      </div>
    </div>
